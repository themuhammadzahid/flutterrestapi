...
class GetProductsList extends StatefulWidget {
  const GetProductsList({Key? key}) : super(key: key);

  @override
  _GetProductsListState createState() => _GetProductsListState();
}

class _GetProductsListState extends State<GetProductsList> {
